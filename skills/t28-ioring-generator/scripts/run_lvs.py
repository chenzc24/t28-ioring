...
def main():
    ...
    from io_ring.verification.lvs import _parse_lvs_summary, _resolve_summary_file
    ...
    try:
        ...
        script_path = skill_dir / "calibre" / "run_lvs.csh"
        if not script_path.exists():
            print(f"[ERROR] Error: LVS script file not found")
            print(f"   Expected path: {script_path}")
            print(f"   Script location: calibre/run_lvs.csh")
            print(f"   Check:")
